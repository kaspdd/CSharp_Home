...
internal class MenuCadastrarNotebook : Menu
{
    public override void Executar(Dictionary<string, Eletronico> eletronicos)
    {
        ...
        while (i == 0)
        {
            Console.Write($"Digite o modelo do notebook: ");
            string modelo = Console.ReadLine()!;
            Console.Write($"Digite a quantidade que deseja cadastrar: ");
            int quantidade = int.Parse(Console.ReadLine()!);
            contN++;
            Notebook n = new Notebook(contN, modelo, quantidade);
            eletronicos.Add(modelo, n);
